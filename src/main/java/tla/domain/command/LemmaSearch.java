...
public class LemmaSearch extends MultiLingSearchCommand<LemmaDto> {
	...
	/**
	 * Only looking for lemma being used in one or more particular egyptian language
	 * stages (e.g. coptic).
	 */
	...
	@JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = TranscriptionSpec.EmptyObjectFilter.class)
	private TranscriptionSpec transcription;

	/**
	 * lemma is written like this in hieroglyphs.
	 */
	@JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = GlyphsSpec.EmptyObjectFilter.class)
	 ...
	 * RootSpec.EmptyObjectFilter.class ) private RootSpec root;
	 */
	private String root;

	/**
	 * Search for lemma with an annotation of the specified type and subtype.
	 */
	@JsonInclude(value = JsonInclude.Include.CUSTOM, valueFilter = TypeSpec.EmptyObjectFilter.class)
	...
	/*
	 * public String getEncodTranscription() { return
	 * transcription.getText()+"|"+transcription.getEnc(); }
	 */
	...
	public class Nominal {
		...
		private String schenkel;

		private String osing;
	}
}
